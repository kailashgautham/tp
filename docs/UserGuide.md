...
| EMAIL         | e/     | Includes letters, numbers, underscores, dots, and dashes, followed by the '@' symbol, then a domain name with at least two characters. | `damithch@comp.nus.edu.sg`, `dcsdcr@nus.edu.sg` |
